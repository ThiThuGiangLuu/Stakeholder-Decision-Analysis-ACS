...
# https://ggrepel.slowkow.com/articles/examples.html
 ...
 ggsave("Figures/FIG1.TIF_expert.Print_with_color.jpeg", dpi=400, height=7, width = 8)
...
#2. Stakeholder power and interest analysis in 2019####
 ...
 #ggsave("Figures/stakeholder_analysis_2019.jpeg", dpi=400, height=7, width = 8)
...
# Combine stakeholer analysis for both 2019 and 2020
 
 SA_2019_2020 <- plot_grid(Stakeholder_analysis_2019, Stakeholder_analysis_2020,
                         labels = c('a)', 'b)'))
                          
 
 ggsave("Figures/FIG3.TIF.SA_2019_2020.Print_with_color.tiff", dpi = 500, 
        width = 15,
        height = 6)
